...
public class BlockC4 extends BlockRDM
{
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Reference.MOD_ID + ":" + "C4BlockSide");
        this.top = p_149651_1_.registerIcon(Reference.MOD_ID + ":" + "C4BlockTop");
        this.front = p_149651_1_.registerIcon(Reference.MOD_ID + ":" + "C4BlockSide");
    }
